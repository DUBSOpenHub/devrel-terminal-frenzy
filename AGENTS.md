# 🎮 DevRel CLI Frenzy — Agent Architecture

## Overview

DevRel CLI Frenzy is a single-file HTML5 arcade game built with AI agents via GitHub Copilot CLI. The entire game — HTML, CSS, JavaScript, sound design — was generated by AI and refined through human-guided iteration.
